    ...
    const skillCategories = [
        {
            ...
            skills: [
                { name: "Angular 14", level: 90, category: "Framework" },
                ...
                { name: "WebSocket", level: 70, category: "Protocol" },
                { name: "Nginx", level: 65, category: "Server" },
                { name: "Frontend Security", level: 75, category: "Security" },
            ],
        },
        {
            id: "backend",
            ...
            skills: [
                ...
                { name: "Java Spring Boot", level: 80, category: "Framework" },
                { name: "MySQL", level: 85, category: "Database" },
                { name: "Docker", level: 75, category: "Container" },
                { name: "Communication Protocols", level: 70, category: "Protocol" },
            ],
        },
        {
            id: "devops",
            ...
            skills: [
                ...
                { name: "GitLab CI/CD", level: 75, category: "CI/CD" },
                { name: "Jira", level: 85, category: "Project Management" },
                { name: "Linux", level: 70, category: "OS" },
                { name: "SonarQube", level: 65, category: "Code Quality" },
            ],
        },
    ]
